package ai.ftech.fekyc.base.extension

import ai.ftech.fekyc.R
import ai.ftech.fekyc.base.common.BaseActivity
import ai.ftech.fekyc.base.common.BaseFragment
import ai.ftech.fekyc.base.common.DebouncedOnClickListener
import ai.ftech.fekyc.base.common.GlobalDebouncedOnClickListener
...
fun View.setOnSafeClick(
    delayBetweenClicks: Long = ai.ftech.fekyc.base.common.DEFAULT_DEBOUNCE_INTERVAL,
...
fun ImageView.setColor(isVerifyApi: Boolean) {
    ImageViewCompat.setImageTintList(this, ColorStateList.valueOf(getAppColor(if(isVerifyApi) R.color.fekyc_color_green else R.color.fekyc_color_text_blue)))
}

fun ImageView.resetColor() {
    ImageViewCompat.setImageTintList(this, ColorStateList.valueOf(getAppColor(R.color.fekyc_color_white)))
}
